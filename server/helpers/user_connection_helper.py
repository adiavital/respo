...
class user_connection_helper(object):
    def __init__(self, user_connection_provider , user_provider):
        self.user_connection_provider = user_connection_provider
        self.user_provider = user_provider

    def get_user_followings_count(self ,user_id):
        following_count_tuple = self.user_connection_provider.select_user_connection_following_count(user_id)
    ...
    def get_user_followings(self, user_id):
        ...
        user_id_tuple = self.user_connection_provider.select_user_connection_following(user_id)
        ...
        for following_user_id in following_id_list:
            ...
            user_deatils_tuple = self.user_provider.select_user(following_user_id)
            ...
            following_user_object_list.append(User(*user_deatils_list))
        return following_user_object_list

    
    def get_user_followers_count(self, user_id):
        followers_count_tuple = self.user_connection_provider.select_user_connection_followers_count(user_id)
        # result is a tuple , so this map take it into a int
    ...
    def get_user_followers(self, user_id):
        ...
        user_id_tuple = self.user_connection_provider.select_user_connection_followers(user_id)
        # result is a tuple , so this map take it into a list
        ...
        for followers_user_id in followers_id_list:
            ...
            map((lambda x: user_deatils_list.append(x)), user_deatils_tuple)
            # making a list that conatine users_object
            followers_user_object_list.append(User(*user_deatils_list))
